...
parser.add_argument('--tracker_name', type=str, help='Name of tracking method.',default='uvltrack')
parser.add_argument('--tracker_param', type=str, help='Name of config file.',default='baseline_base')
parser.add_argument('--dataset_name', type=str, help='Name of config file.',default='lasot_NL_300')
