...
def parameters(yaml_name: str, extra_cfg=None, epoch=None):
    ...
    prj_dir ='/home/qui_wzh/20240630/home/language-guided-tracking/UVLTrack-master'  #TODO:just for debug
    ...
    params.checkpoint = os.path.join(prj_dir, "checkpoints/train/uvltrack/%s/UVLTrack_ep%04d.pth.tar"%(yaml_name, cfg.TEST.EPOCH))  #TODO:just for debug
