    ...
    def _track_sequence(self, Tracker, seq, init_info, debug,test_dino=False,test_yolo=False):
        ...
        if test_dino:
            ...
            if self.model is None:
                ...
                checkpoint="/home/qui_wzh/20240630/home/language-guided-tracking/UVLTrack-master/work_dir/baseline_yolotracker_finetune_spatial_adn_temporaltnl2kepoch30_dev_correct_tracking/checkpoints/train/uvltrack/baseline_base_yolo_finetune_spatial_and_temporal_tnl2k_tracking_size320/YOLOWorldDetector_ep0030.pth.tar" #tracking方式训练，引入空间和时序，joint数据集训练epoch 30

                      
                #checkpoint="/home/qui_wzh/20240630/home/language-guided-tracking/UVLTrack-master/work_dir/baseline_yolotracker_finetune_spatial_adn_temporaljointepoch30_dev_correct_tracking/checkpoints/train/uvltrack/baseline_base_yolo_finetune_spatial_and_temporal_joint_tracking_size320_moredataset/YOLOWorldDetector_ep0030.pth.tar" #tracking方式训练，引入空间和时序，更多数据集训练epoch 30
