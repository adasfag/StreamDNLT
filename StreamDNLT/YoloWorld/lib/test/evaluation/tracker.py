    ...
    def _track_sequence(self, tracker, seq, init_info, debug,test_dino=False,test_yolo=False):
        ...
        if test_dino:
            ...
            if self.model is None:
                ...
                checkpoint="/home/qui_wzh/20240630/home/language-guided-tracking/UVLTrack-master/work_dir/baseline_yolotracker_finetune_spatial_adn_temporaljointepoch30_dev_correct/checkpoints/train/uvltrack/baseline_base_yolo_finetune_spatial_and_temporal_joint_dev/YOLOWorldDetector_ep0030.pth.tar" #全picture方式训练，引入时序了，joint数据集训练epoch 30
