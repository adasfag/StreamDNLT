    ...
    def _track_sequence(self, tracker, seq, init_info, debug,test_dino=False,test_yolo=False):
        ...
        if test_dino:
            ...
            if self.model is None:  
                ...
                model = load_model_from_fine_tune("/home/qui_wzh/20240630/home/language-guided-tracking/UVLTrack-master/lib/groundingdino/config/GroundingDINO_SwinT_OGC_track_adapter_optimise.py", "/home/qui_wzh/20240630/home/language-guided-tracking/UVLTrack-master/work_dir/baseline_dinotracker_epoch30joint_tracking/checkpoints/train/uvltrack/baseline_base_dino_memory_joint/GroundingDINOTrackerAdapterMemory_ep0010.pth.tar")
