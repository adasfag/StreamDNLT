...
class TrackingNet(BaseVideoDataset):
    ...
    def _load_class_info(self):
        ...
        for i, seq in enumerate(self.sequence_list):
            class_name = seq_to_class_map.get(seq[1], 'object, thing or foreground')
    ...
    def get_frames(self, seq_id, frame_ids, anno=None):
        ...
        object_meta = OrderedDict({'object_class_name': obj_class,
                                   ...
                                   'root_class': None,
                                   'motion_adverb': None,
                                   'language': generate_sentence(obj_class.lower())})

        return frame_list, anno_frames, object_meta
    
    def get_frames_path(self, seq_id, frame_ids, anno=None):
        frame_list = [self._get_frame_path(seq_id, f) for f in frame_ids]
