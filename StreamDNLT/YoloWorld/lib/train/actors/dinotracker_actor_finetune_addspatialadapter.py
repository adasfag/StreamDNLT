...
@registry.ACTORS.register("dinotracker_finetune_spatialadapter")
class DINOTrackActor(BaseActor):
    ...
    def forward_pass(self, data):
        ...
        out_dict =self.net(search_images, test=False,captions=ori_text,template_images=template_images,flag=flag)
        return out_dict
